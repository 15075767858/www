...
`key1_value` float(5,5) NULL,

`key2_value` float(5,5) NULL,

`key3_value` float(5,5) NULL,

`key4_value` float(5,5) NULL,

`key5_value` float(5,5) NULL,

`key6_value` float(5,5) NULL,

`key7_value` float(5,5) NULL,

`key8_value` float(5,5) NULL,
